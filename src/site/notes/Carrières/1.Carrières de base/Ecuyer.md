---
{"dg-publish":true,"permalink":"/carrieres/1-carrieres-de-base/ecuyer/","tags":["Carrière","Carrière/Base"],"dg-note-properties":{"tags":["Carrière","Carrière/Base"],"aliases":["Écuyer"]}}
---

# Écuyer
**Type :** Carrière de base
**Source :** Livre de base p.41 / Core Rulebook p.54 *Squire*
## 📜 Description
...
*Note : Si vous prenez Connaissances générales (Bretonnie) et Langue (bretonnien) lors de la création de personnage, vous pouvez être originaire de Bretonnie si vous le souhaitez.*
...
## 🎒 Dotations
Demi-lance
Armure moyenne (*[[Gilet de mailles\|gilet de mailles]]*, *[[Cagoule de mailles\|cagoule de mailles]]* et *[[Veste de cuir\|veste de cuir]]*)
Bouclier
