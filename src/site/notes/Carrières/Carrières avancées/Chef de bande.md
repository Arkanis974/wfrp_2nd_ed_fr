---
{"dg-publish":true,"permalink":"/carrieres/carrieres-avancees/chef-de-bande/","tags":["Carrière","Carrière/Avancée"],"dg-note-properties":{"tags":["Carrière","Carrière/Avancée"],"Lien":["[[Accueil]]","[[Listes des carrières]]"]}}
---

# Chef de bande
**Type :** Carrière avancée
**Source :** Livre de base p.67/ Core Rulebook p.79 *Outlaw chief*
## 📜 Description
Toutes les bandes de brigands ont besoin d’un chef. Ainsi, le hors-la-loi qui fait montre de courage et d’ingéniosité peut s’élever au range de Chef de bande. Cependant, prendre la tête d’un groupe d’hommes sans foi ni loi n’est pas chose aisée, d’autant que les dangereuses forêts du [[Vieux Monde\|Vieux Monde]] ne facilitent pas la tâche. Les Chefs de bande ont la part du lion des butins acquis par le groupe, mais ils sont également responsables des échecs de la bande, ce qui peut parfois leur couter leur place, et leur vie. Les groupes de hors-la-loi sont connus pour ne pas laisser leurs membres prendre leur retraite, si bien que les Chefs de bande ont parfois du mal à quitter leur fonction.
...
---
## 📚 Compétences
[[Compétences/Alphabet secret\|Alphabet secret]] (*pisteur* ou *voleur*)
...
---
## 🎒 Dotations
Arc avec 10 flèches ou Arbalète avec 10 carreaux
Armure moyenne (*[[Chemise de mailles\|Chemise de mailles]]* et *[[Veste de cuir\|Veste de cuir]]*)
